import 'package:with_edu/core/utils/app_text_styles.dart';
import 'package:with_edu/data/models/groups/group.dart';
import 'package:with_edu/logic/bloc/admin_group_management/admin_group_management_bloc.dart';
import 'package:with_edu/ui/screens/admin_panel/groups/widgets/edit_group_students_dialog.dart';
import 'package:with_edu/ui/screens/admin_panel/groups/widgets/edit_group_dialog.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(
              height: 8), // Add some space between rows for better readability
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              /// edit student button
